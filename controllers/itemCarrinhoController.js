const ModeloItemCarrinho = require('../models/itemCarrinhoModel');
...
class controladorItemCarrinho{
    ...
    async atualizarItemCarrinho( req, res ){
        ...
        const item_carrinho = req.body; 
        try{
            const resultado = await ModeloItemCarrinho.atualizarItemCarrinho(id_item_carrinho, item_carrinho);
            if( resultado ){
